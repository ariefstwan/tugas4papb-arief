...
import com.example.tugas4papbg.databinding.ItemNoteBinding;
import com.example.tugas4papbg.helper.NoteDiffCallback;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    intent.putExtra(InsertUpdateActivity.EXTRA_NOTE, (Parcelable) note);
